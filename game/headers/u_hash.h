...
#define U_HAS_ITEM_WEAPON(item_holder,table)({unsigned long long hash; hash = u_hash(2,table, quality_name_modifier[((struct Weapon*)item_holder->item->item_specific_info)->quality] , material_name_modifier[((struct Weapon*)item_holder->item->item_specific_info)->material] , handed_modifier[((struct Weapon*)item_holder->item->item_specific_info)->variant], mele_weapon_name_modifier[((struct Weapon*)item_holder->item->item_specific_info)->kind] ); hash;})
