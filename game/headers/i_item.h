...
*/
#define HAS_ITEM_NAME_WEAPON(source_item_holder, target_item_holder)(((struct I_Weapon *)source_item_holder->item->item_specific_info)->quality == ((struct I_Weapon *)target_item_holder->item->item_specific_info)->quality && ((struct I_Weapon *)source_item_holder->item->item_specific_info)->material == ((struct I_Weapon *)target_item_holder->item->item_specific_info)->material && ((struct I_Weapon *)source_item_holder->item->item_specific_info)->variant == ((struct I_Weapon *)target_item_holder->item->item_specific_info)->variant && ((struct I_Weapon *)source_item_holder->item->item_specific_info)->kind == ((struct I_Weapon *)target_item_holder->item->item_specific_info)->kind ? 0 : 1)


#define HAS_ITEM_NAME_ARMOR(source_item_holder, target_item_holder)({int is_equal; const char *source_item_holder_quality = quality_name_modifier[((struct I_Armor *)source_item_holder->item->item_specific_info)->quality]; const char *source_item_holder_material = material_name_modifier[((struct I_Armor *)source_item_holder->item->item_specific_info)->material]; const char *source_item_holder_armor_type = equipment_type_modifier[((struct I_Armor *)source_item_holder->item->item_specific_info)->armor_type]; char *target_item_holder_quality = quality_name_modifier[((struct I_Armor *)target_item_holder->item->item_specific_info)->quality]; const char *target_item_holder_material = material_name_modifier[((struct I_Armor *)target_item_holder->item->item_specific_info)->material]; const char *target_item_holder_armor_type = equipment_type_modifier[((struct I_Armor *)target_item_holder->item->item_specific_info)->armor_type]; is_equal = (strcmp(source_item_holder_quality,target_item_holder_quality) | strcmp(source_item_holder_material,target_item_holder_material) | strcmp(source_item_holder_armor_type,target_item_holder_armor_type) ); is_equal;})
