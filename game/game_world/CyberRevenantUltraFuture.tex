 ...
 \hline
  \multicolumn{4}{|c|}{\textbf{Indexes, keys and constraints}} \\
   ...
   \multicolumn{4}{|p{5cm}|}{PRIMARY KEY(dialogue{\_}folder{\_}id, current{\_}dialogue{\_}id)} \\
      \multicolumn{4}{|p{5cm}|}{CREATE UNIQUE INDEX IF NOT EXISTS(dialogue{\_}folder{\_}id, current{\_}dialogue{\_}id)} \\
 \hline
...
\hline
   \multicolumn{4}{|p{5cm}|}{PRIMARY KEY(dialogue{\_}folder{\_}id, current{\_}dialogue{\_}id, selected\_option} \\
      \multicolumn{4}{|p{5cm}|}{CREATE UNIQUE INDEX IF NOT EXISTS(dialogue{\_}folder{\_}id, current{\_}dialogue{\_}id, selected{\_option}} \\ 
   \hline
...
\hline
 ...
 initial\_id & 4 & int & The next initial id \\
 \hline
\multicolumn{4}{|c|}{\textbf{Indexes, keys and constraints}}  \\
\hline
   \multicolumn{4}{|p{5cm}|}{PRIMARY KEY(dialogue{\_}folder{\_}id, current{\_}dialogue{\_}id, selected\_option, on\_outcome} \\
      \multicolumn{4}{|p{5cm}|}{CREATE UNIQUE INDEX IF NOT EXISTS(dialogue{\_}folder{\_}id, current{\_}dialogue{\_}id, selected{\_option}, on{\_outcome}} \\ 
   \hline
   \multicolumn{4}{|p{5cm}|}{FOREIGN KEY(dialogue{\_}folder{\_}id, current{\_}dialogue{\_}id), REFERENCES dia\_dialogue\_interactions(dialogue{\_}folder{\_}id, current{\_}dialogue{\_}id)} \\      
\multicolumn{3}{|c|}{Table name} & Role \\
\hline
