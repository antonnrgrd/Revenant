...
\hline
 \multicolumn{4}{|c|}{\textbf{Table:dia\_dialogue\_selected\_option\_consequence\_handler}} \\
 \hline
 Column name & Column index & Data type & Description \\
  \hline
 ...
 consequence & 3 & int & The consequence for picking the selected\_option  \\
 next\_current\_dialogue\_if\_successful & 4 & int & The next current dialogue to read in, provided the passed the checks, if any. \\
 \hline
\multicolumn{4}{|c|}{\textbf{Indexes, keys and constraints}}  \\
\hline
...
\hline
\end{tabular}
\label{Tab:diadialogueselectedoptionconsequencehandler}
\end{table}
