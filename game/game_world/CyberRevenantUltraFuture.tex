...
\hline
 \multicolumn{3}{|c|}{\textbf{Table:dia\_dialogue\_interactions}} \\
 \hline
 Column name & Index & Data type \\
  \hline
 dialogue\_folder\_id & 0 & int\\
 current\_dialogue\_id & 1 & int\\
 num\_dialogue\_options & 2 & int\\
 \hline
  \multicolumn{3}{|c|}{\textbf{Indexes, keys and constraints}} \\
   \hline
   \multicolumn{3}{|p{5cm}|}{PRIMARY KEY(dialogue{\_}folder{\_}id, current{\_}dialogue{\_}id} \\
      \multicolumn{3}{|p{5cm}|}{CREATE UNIQUE INDEX IF NOT EXISTS(dialogue{\_}folder{\_}id, current{\_}dialogue{\_}id} \\
 \hline
\multicolumn{3}{|c|}{\textbf{Dependencies of dia\_dialogue\_interactions}}  \\
\hline
\multicolumn{3}{|c|}{Table dependencies of dia\_dialogue\_interactions}  \\
\hline
\multicolumn{2}{|c|}{Table name} & Role \\%Table name & Role \\
\hline
\multicolumn{2}{|c|}{dia\_dialogue\_selected\_option\_consequence\_handler - \ref{Tab:diadialogueselectedoptionconsequencehandler}} & If any checks are to be made as a consequence of a selected dialogue options, e.g skill check, trigger check this table will also have to be read from. \\
\hline
\end{tabular}
\end{table}
