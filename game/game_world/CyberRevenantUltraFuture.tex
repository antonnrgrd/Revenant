...
\hline
 \multicolumn{2}{|c|}{\textbf{Table:dia\_dialogue\_interactions}} \\
 \hline
 Column name & Data type \& and constraints\\
  \hline
 dialogue\_folder\_id & int\\
 current\_dialogue\_id & int\\
 num\_dialogue\_options & int\\
 \hline
  \multicolumn{2}{|c|}{\textbf{Indexes, keys and constraints}} \\
   \hline
   \multicolumn{2}{|p{5cm}|}{PRIMARY KEY(dialogue{\_}folder{\_}id, current{\_}dialogue{\_}id} \\
      \multicolumn{2}{|p{5cm}|}{CREATE UNIQUE INDEX IF NOT EXISTS(dialogue{\_}folder{\_}id, current{\_}dialogue{\_}id} \\
 \hline
\multicolumn{2}{|c|}{\textbf{Dependencies of dialogue\_interactions}}  \\
\hline
\multicolumn{2}{|c|}{Table dependencies of dialogue\_interactions}  \\
\hline
Table name & Role \\
\hline
