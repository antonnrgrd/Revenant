...
\hline
 \multicolumn{2}{|c|}{\textbf{Table:dialogue\_interactions}} \\
 \hline
 ...
 \hline
  \multicolumn{2}{|c|}{\textbf{Indexes, keys and constraints}} \\
   \hline
   \multicolumn{2}{|p{5cm}|}{PRIMARY KEY(dialogue{\_}folder{\_}id, current{\_}dialogue{\_}id, num{\_}dialogue{\_}options)} \\
      \multicolumn{2}{|p{5cm}|}{CREATE UNIQUE INDEX IF NOT EXISTS(dialogue{\_}folder{\_}id, current{\_}dialogue{\_}id, num{\_}dialogue{\_}options)} \\
 \hline
...
Table name & Role \\
\hline
dialogue\_consequence\_checks & If any checks are to be made as a consequence of a selected dialogue options, e.g skill check, trigger check this table will also have to be read from.
\end{tabular}
\end{table}
...
\begin{tabular}{ |p{5cm}|p{3cm}|  }
\hline
 \multicolumn{2}{|c|}{\textbf{Table:dialogue\_consequence\_checks}} \\
 \hline
...
\hline
 \multicolumn{2}{|c|}{\textbf{Table:selected\_dialogue\_option }} \\
 \hline
 Column name & Data type, constraints \& description\\
  \hline
 dialogue\_folder\_id & int - dialogue folder id of the Dia\_Dialogue\_Manager used for the current dialogue session.\\
 current\_dialogue\_id & int - the current dialogue\_id file being read from the dialogue folder.\\
 selected\_option & int - the dialogue option the\\
 check\_type & int - The type of check in question to be made e.g skill check, trigger check, etc..\\
 \hline
\multicolumn{2}{|c|}{\textbf{Dependencies of dialogue\_interactions}}  \\
\hline
\multicolumn{2}{|c|}{Table dependencies of dialogue\_interactions}  \\
